...
<div id="content" role="main">
    ...
    <section class="cont-right pdg-home">
        <p class="txt-chamada">Compromisso com a segurança.</p>

        <h1 class="txt-red">Produtos</h1>

        <p>Confira ao lado nossa linha de tanques rodoviários e escolha o modelo que mais se ajusta às suas necessidades. Fabricamos tanques de coleta, julieta, semi-reboque, bitrem, vanderleia, além de equipamentos e acessórios que facilitam o manuseio e estocagem nos tanques.</p>

        <img src="img/caminhao.jpg" height="203" width="588" alt="Produtos Inox Fantasia" />
