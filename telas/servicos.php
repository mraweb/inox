...
<div id="content" role="main">
    ...
    <section class="cont-right pdg-home">
        <p class="txt-chamada">Reformas e Aluguéis de Tanques Rodoviários</p>

        <h1 class="txt-red">Serviços Inox Fantasia</h1>

        <p>Oferecemos também serviços especializados de <strong>reformas e aluguéis de tanques rodoviários</strong> para empresas que necessitam de aumento temporário de frota para suprir a demanda de transporte.</p>
